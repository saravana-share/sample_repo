$(document).ready(function() {
    ...
    $('#Leave-Approval-table').DataTable({
        "language": {
            "search": "",
            "lengthMenu": "_MENU_",
            "paginate": {
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.employee_id = $('#approve_employee_id').val();
        ...
        columns: [
            ...
            { data: 'approve_status', name: 'leaves.status', searchable: true },
    ...
    var datTable = $('#Leave-Approval-table').dataTable();
    ...
    $('#approve_employee_id').change(function() {
