...
$(document).ready(function() {
    ...
    $('body').on('click', '#add_test_case', function(event) {
        var div = $('#dummy_test_case').val('').html();
        div = div.replace(/xxx/g, test_case_count);
        $('.test_case_wrapper').append(div);
    ...
    var form_id = "#form_dev";
    var v = jQuery(form_id).validate({
        ignore: "",
        rules: {
            task_status_id: {
                required: function(element) {
                    return $('#status_change_yes').is(':checked')
                }
            },
            actual_date: {
                required: true,
